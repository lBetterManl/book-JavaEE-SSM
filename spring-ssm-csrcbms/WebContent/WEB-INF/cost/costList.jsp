...
<html xmlns="http://www.w3.org/1999/xhtml"> 
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function startFee(id) {
                ...
                if(r) {
               		window.location.href = "startFee?id="+id;
               	}
            }
            //删除
    ...
    <body>
        ...
        <!--主要区域开始-->
        <div id="main">
            <form action="findCost" method="post" id="costForm">
                <!--排序-->
	                            ...
	                            <td>
	                            	<c:choose>
	                            		...
	                            		<c:otherwise>
			                                ...
			                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateCost?id=${cost.costId}';" />
                ...
                <div id="pages">
                	<c:choose>
                		...
                		<c:otherwise>
                			<a href="findCost?currentPage=${costPage.currentPage-1 }">上一页</a>
                		</c:otherwise>
                	</c:choose>
        	        ...
        	        <c:forEach begin="1" end="${costPage.totalPage }" var="p">
        	        	<c:choose>
        	        		<c:when test="${p==costPage.currentPage }">
        	        			<a href="findCost?currentPage=${p }" class="current_page">${p }</a>
        	        		</c:when>
        	        		<c:otherwise>
        	        			<a href="findCost?currentPage=${p }">${p }</a>
        	        		</c:otherwise>
        	        	</c:choose>
                    </c:forEach>
                    ...
                    <c:choose>
                		...
                		<c:otherwise>
                			<a href="findCost?currentPage=${costPage.currentPage+1 }">下一页</a>
                		</c:otherwise>
                	</c:choose>
                </div>
            </form>
