    ...
    <body>
        ...
        <div id="main">            
            ...
            <form action="updateCost" method="post" class="main_form">
                ...
                <div class="input_info"><input type="text" name="costId" class="readonly" readonly value="${cost.costId }" /></div>
                ...
                <div class="input_info fee_type">
                    <input type="radio" name="costType" value="1" id="monthly" onclick="feeTypeChange(1);" <c:if test="${cost.costType==1 }">checked</c:if> />
                    <label for="monthly">包月</label>
                    <input type="radio" name="costType" value="2" id="package" onclick="feeTypeChange(2);" <c:if test="${cost.costType==2 }">checked</c:if> />
                    <label for="package">套餐</label>
                    <input type="radio" name="costType" value="3" id="timeBased" onclick="feeTypeChange(3);" <c:if test="${cost.costType==3 }">checked</c:if> />
