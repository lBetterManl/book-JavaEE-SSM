    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            function deleteRole(id) {
                ...
                if(r) {
                	window.location.href = "deleteRole?id="+id;
                }
            }
        </script>
    </head>
            ...
            <form action="" method="">
                    ...
                    <table id="datalist">
                        ...
                        <c:forEach items="${roles }" var="role">              
	                        <tr>
	                            ...
	                            <td>
	                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateRole?id=${role.roleId }';"/>
                ...
                <div id="pages">
                	<c:choose>
                		...
                		<c:otherwise>
                			<a href="findRole?currentPage=${rolePage.currentPage-1 }">上一页</a>
                		</c:otherwise>
                	</c:choose>
        	        ...
        	        <c:forEach begin="1" end="${rolePage.totalPage }" var="p">
        	        	<c:choose>
        	        		<c:when test="${p==rolePage.currentPage }">
        	        			<a href="findRole?currentPage=${p }" class="current_page">${p }</a>
        	        		</c:when>
        	        		<c:otherwise>
        	        			<a href="findRole?currentPage=${p }">${p }</a>
        	        		</c:otherwise>
        	        	</c:choose>
                    </c:forEach>
                    ...
                    <c:choose>
                		...
                		<c:otherwise>
                			<a href="findRole?currentPage=${rolePage.currentPage+1 }">下一页</a>
                		</c:otherwise>
                	</c:choose>
                </div>
            </form>
