    ...
    <head>
        ...
        <script language="javascript" type="text/javascript">
            ...
            function deleteAdmin(id) {
                ...
                if(r) {
                	window.location.href = "deleteAdmin?adminId="+id;
                }
            }
            //全选
            ...
            <form action="findAdmin" method="post">
                    ...
                    <table id="datalist">
                        ...
                        <c:forEach items="${admins }" var="admin">
	                        <tr>
	                            ...
	                            <td class="td_modi">
	                                <input type="button" value="修改" class="btn_modify" onclick="location.href='toUpdateAdmin?id=${admin.adminId }';" />
                ...
                <div id="pages">
                	<c:choose>
                		...
                		<c:otherwise>
                			<a href="findAdmin?currentPage=${adminPage.currentPage-1 }">上一页</a>
                		</c:otherwise>
                	</c:choose>
        	        ...
        	        <c:forEach begin="1" end="${adminPage.totalPage }" var="p">
        	        	<c:choose>
        	        		<c:when test="${p==adminPage.currentPage }">
        	        			<a href="findAdmin?currentPage=${p }" class="current_page">${p }</a>
        	        		</c:when>
        	        		<c:otherwise>
        	        			<a href="findAdmin?currentPage=${p }">${p }</a>
        	        		</c:otherwise>
        	        	</c:choose>
                    </c:forEach>
                    ...
                    <c:choose>
                		...
                		<c:otherwise>
                			<a href="findAdmin?currentPage=${adminPage.currentPage+1 }">下一页</a>
                		</c:otherwise>
                	</c:choose>
                </div>                    
            </form>
